...
export const tools: ToolDefinition[] = [
  ...
  // ==================== IMAGE TOOLS ====================
  { cat: "image", popular: true, titleKey: "tool.studio_editor", title: "Studio Editor", descKey: "tool.studio_editor_desc", desc: "Edit foto, filter, crop, & grading.", href: "/image/editor", color: "pink", category: "Image", descFallback: "Edit gambar sederhana", icon: '<circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/>' },
  ...
  { cat: "image", popular: false, titleKey: "tool.image_converter", title: "Image Converter", descKey: "tool.image_converter_desc", desc: "Ubah format PNG/JPG/WEBP.", href: "/image/converter", color: "sky", category: "Image", descFallback: "Konversi format gambar", icon: '<rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/>' },
  { cat: "image", popular: false, titleKey: "tool.color_picker", title: "Color Picker", descKey: "tool.color_picker_desc", desc: "Ambil warna dari gambar.", href: "/image/color", color: "pink", category: "Image", descFallback: "Picker dan konversi warna", icon: '<circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/>' },
  { cat: "image", popular: false, titleKey: "tool.html_to_image", title: "HTML to Image", descKey: "tool.html_to_image_desc", desc: "Convert kode HTML jadi gambar.", href: "/image/html-to-img", color: "pink", category: "Image", descFallback: "Konversi HTML ke gambar", icon: '<rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><polyline points="11 3 11 11 14 8 17 11 17 3"/>' },
  ...
  { cat: "dev", popular: false, titleKey: "tool.cron_generator", title: "Cron Generator", descKey: "tool.cron_generator_desc", desc: "Buat jadwal Cron Job.", href: "/dev/cron", color: "orange", category: "Dev", descFallback: "Generator ekspresi cron", icon: '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>' },
  ...
  { cat: "utils", popular: false, titleKey: "tool.pomodoro_timer", title: "Pomodoro Timer", descKey: "tool.pomodoro_timer_desc", desc: "Timer fokus kerja.", href: "/utils/pomodoro", color: "rose", category: "Utils", descFallback: "Timer produktivitas", icon: '<circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/>' },
  ...
  { cat: "utils", popular: false, titleKey: "tool.stopwatch", title: "Stopwatch", descKey: "tool.stopwatch_desc", desc: "Penghitung waktu.", href: "/utils/stopwatch", color: "cyan", category: "Utils", descFallback: "Stopwatch sederhana", icon: '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>' },
