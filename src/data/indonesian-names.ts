...
export const ethnicGroups: EthnicGroup[] = [
  {
    ...
    male: ['Joko', 'Bambang', 'Slamet', 'Suprapto', 'Agus', 'Budi', 'Eko', 'Dedi', 'Heru', 'Wahyu', 'Sigit', 'Bagus', 'Adi', 'Tri', 'Nur', 'Rizky', 'Yoga', 'Dimas', 'Rangga', 'Arif', 'Bayu', 'Fajar', 'Reza', 'Galih', 'Cahyo', 'Yudi', 'Endra', 'Satrio', 'Pramudya', 'Wibowo', 'Danang', 'Gunawan', 'Hendra', 'Joko', 'Kurnia', 'Suryo'],
  ...
  },
  {
    ...
    male: ['Togar', 'Mangapul', 'Binsar', 'Dompak', 'Sahat', 'Marolop', 'Poltak', 'Roy', 'Ricardo', 'Andar', 'Jannes', 'Thomson', 'Robert', 'Rudi', 'Binsar', 'Jhon', 'Elvis', 'Panusunan', 'Saut', 'Tumpal', 'Sabam', 'Bonar', 'Raja', 'Frans', 'Agus', 'Binsar', 'Doli', 'Herman', 'Posman', 'Ramses'],
    female: ['Dame', 'Rotua', 'Lasma', 'Rusmina', 'Tiur', 'Hotma', 'Sondang', 'Mariana', 'Rosmery', 'Elida', 'Renta', 'Lisbet', 'Sarma', 'Bunga', 'Nurhayati', 'Kristina', 'Ria', 'Masni', 'Tiodora', 'Sinta', 'Martha', 'Dewi', 'Sumiati', 'Hotna', 'Nova', 'Ria', 'Lame', 'Ruth', 'Elisabeth', 'Gloria'],
  ...
  },
  {
    ...
    female: ['Ayu', 'Ratih', 'Dewi', 'Sri', 'Laksmi', 'Candra', 'Sintya', 'Indah', 'Putri', 'Wulan', 'Ayu', 'Gita', 'Saraswati', 'Widhi', 'Paramita', 'Cempaka', 'Melati', 'Sari', 'Maya', 'Diah', 'Ratna', 'Kartika', 'Yuni', 'Dina', 'Sinta', 'Puspita', 'Laras', 'Niluh', 'Made', 'Desi'],
  ...
  },
  {
    ...
    female: ['Siti', 'Fatimah', 'Aisyah', 'Nur', 'Zainab', 'Mariam', 'Khadijah', 'Rahmah', 'Halimah', 'Salmah', 'Azizah', 'Husna', 'Farah', 'Suhaila', 'Rohani', 'Maimunah', 'Jamilah', 'Hasnah', 'Latifah', 'Salmah', 'Zaleha', 'Norliza', 'Aminah', 'Rosmawati', 'Suryani', 'Dahlia', 'Melati', 'Kartini', 'Sofiah', 'Nafisah'],
  ...
  },
  {
    ...
    male: ['Hendra', 'Andi', 'Steven', 'Kevin', 'Ricky', 'Denny', 'Wilson', 'Hansen', 'Felix', 'Jonathan', 'Samuel', 'Marco', 'Vincent', 'William', 'Nicholas', 'Timothy', 'Albert', 'Bryan', 'Christian', 'Daniel', 'Erick', 'Felix', 'Gregory', 'Ivan', 'Jason', 'Kelvin', 'Leon', 'Michael', 'Nathaniel', 'Oscar'],
    ...
    surnames: ['Liem', 'Tan', 'Wijaya', 'Hartono', 'Gunawan', 'Halim', 'Salim', 'Santoso', 'Susanto', 'Kurniawan', 'Hidayat', 'Setiawan', 'Budiman', 'Kusuma', 'Tjandra', 'Winata', 'Ong', 'Tio', 'Sutanto', 'Handoko', 'Surya', 'Liem', 'Cahyadi', 'Prawira', 'Saputra'],
    note: '',
  },
  {
    id: 'arab',
